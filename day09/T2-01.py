...
import numpy
print(numpy.__version__) # 2.4.4, 넘파이 버전 확인
...
x = numpy.ones((2, 3)) # .ones((행, 열)), 행과 열 만큼의 1으로 배열 초기화
print(x) # [[1. 1. 1.]
         # [1. 1. 1.]]
...
x = numpy.linspace(0, 1, 5) # .linspace(시작, 단위, 개수), 시작부터 끝 사이의 개수만큼 균등하게 나눈 배열
