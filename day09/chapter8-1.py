...
# [3] 인스턴스 생성 하기
students = [Student("윤인성1", 87, 98, 88, 95),  # 인스턴스 생성, JAVA : new 클래스명(인자값) vs PY : 클래스명(인자값) 
...
# 클래스는 어떠한 구조를 미리 설계하여 통일 되고 상태와 행동ㄷ 오차 줄일 수 있다.
students = [{'name' : '윤인성1', 'korean' : 87, 'math' : 98, 'english' : 88, 'science' : 95},
