...
d = int(input("첫 번째 점수를 입력하세요: "))
e = int(input("두 번째 점수를 입력하세요: "))
...
i = int(input("주민번호 뒷자리 첫 번째 숫자를 입력하세요> "))
...
p1 = int(input("플레이어1 (가위:0, 바위:1, 보:2): "))
p2 = int(input("플레이어2 (가위:0, 바위:1, 보:2): "))
