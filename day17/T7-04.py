...
async def joongnaRun() : 
    ...
    async with async_playwright() as p :
        ...
        # [5-1] 특정한 검색창 활용
        await page.get_by_placeholder('최소 가격').fill('10000') # '최소 가격' 입력상자에 10000대입
        await page.wait_for_timeout(1000)
        
        await page.get_by_placeholder('최대 가격').fill('20000') # '최대 가격' 입력상자에 20000대입
        await page.wait_for_timeout(1000)
        ...
        # [6] 특정한 요소 가져오기, 주의할 점 : 식별자가 불명확할 경우에는 자식/자손 선택자 활용
        # 선택자 : a[href^="/product/"], 해당 링크가 시작하는 링크
